...
# csmit -m 100G -c 32 "/applications/R/R-3.3.2/bin/Rscript permTest_peri_HTA7_overlapping_H3K9me2_peaks_vs_TEfams.R 10000"

args <- commandArgs(trailingOnly = T)
perms <- as.numeric(args[1])

peakName1 <- "HTA7_overlapping_H3K9me2_peri_peaks"
...
HTA7_H3K9me2_overlaps <- findOverlaps(query = H3K9me2,
                                      ...
                                      ignore.strand = TRUE,
                                      select = "all")
peaksGR <- HTA7[unique(subjectHits(HTA7_H3K9me2_overlaps))]
