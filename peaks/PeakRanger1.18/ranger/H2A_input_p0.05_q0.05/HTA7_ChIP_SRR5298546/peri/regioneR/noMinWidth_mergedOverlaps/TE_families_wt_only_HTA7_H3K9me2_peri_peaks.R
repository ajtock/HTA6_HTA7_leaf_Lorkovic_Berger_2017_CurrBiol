...
# Usage:
# ./TE_families_wt_only_HTA7_H3K9me2_peri_peaks.R "Pericentromeric HTA7 peaks overlapping H3K9me2 peaks" "HTA7_H3K9me2" HTA7_overlapping_H3K9me2 HTA7_overlapping_H3K9me2 peri 10000

library(ggplot2)
library(ggthemes)

#plotTitle <- "Pericentromeric HTA7 peaks overlapping H3K9me2 peaks"
#pt1Name <- ""HTA7_H3K9me2""
#pt1LibName <- "HTA7_overlapping_H3K9me2" 
#ptOrderLibName <- "HTA7_overlapping_H3K9me2"
#region <- "peri" 
...
bp <- ggplot(data = df,
  ...
  scale_y_continuous(limits = c(-2.5, 5.0)) +
