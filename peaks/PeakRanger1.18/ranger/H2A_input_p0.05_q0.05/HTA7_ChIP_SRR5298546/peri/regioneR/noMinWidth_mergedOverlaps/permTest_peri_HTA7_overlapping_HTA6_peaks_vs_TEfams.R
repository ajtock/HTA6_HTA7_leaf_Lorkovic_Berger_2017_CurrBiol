...
# csmit -m 100G -c 32 "/applications/R/R-3.3.2/bin/Rscript permTest_peri_HTA7_overlapping_HTA6_peaks_vs_TEfams.R 10000"

args <- commandArgs(trailingOnly = T)
perms <- as.numeric(args[1])

peakName1 <- "HTA7_overlapping_HTA6_peri_peaks"
