...
# Usage:
# ./TE_families_wt_only_HTA7_overlapping_HTA6_genomewide_peaks.R "Genome-wide HTA7 peaks overlapping HTA6 peaks" "HTA7_HTA6" HTA7_overlapping_HTA6 HTA7_overlapping_HTA6 genomewide 10000

library(ggplot2)
library(ggthemes)

#plotTitle <- "Genome-wide HTA7 peaks overlapping HTA6 peaks"
#pt1Name <- "HTA7_HTA6"
