...
# Profile mean coverage around DNA TEs overlapped by HTA7_not_HTA6 peaks and random loci

# Usage via Condor submission system on node7:
#csmit -m 20G -c 1 "/applications/R/R-4.0.0/bin/Rscript ./TE_DNAfams_Profiles_commandArgs_HTA7_not_HTA6.R 2000 2kb 20 /projects/ajt200/BAM_masters/SPO11-oligo/WT/coverage/log2ChIPinput/noZscore/log2wtSPO11oligoRPI1NakedDNA_norm_allchrs_coverage_coord_tab_noZscore.bed SPO11_1_oligos_RPI1 HTA7_not_HTA6 genomewide"
