...
# Profile mean coverage around RNA TEs overlapped by HTA7_not_HTA6 peaks and random loci

# Usage via Condor submission system on node7:
#csmit -m 20G -c 1 "/applications/R/R-4.0.0/bin/Rscript ./TE_RNAfams_Profiles_commandArgs_HTA7_not_HTA6.R 2000 2kb 20 /projects/ajt200/BAM_masters/SPO11-oligo/WT/coverage/log2ChIPinput/noZscore/log2wtSPO11oligoRPI1NakedDNA_norm_allchrs_coverage_coord_tab_noZscore.bed SPO11_1_oligos_RPI1 HTA7_not_HTA6 genomewide"
...
#                               mask = mask,
  ...
  outDF <- list(paste0(matDir, libName,
                       "_norm_cov_", RNAfamNames[h], "_TEs_overlapping_", peaks, "_", region, "_peaks_smoothed_target_and_", flankName, "_flank_dataframe.txt"),
                paste0(matDir, libName,
                       "_norm_cov_", RNAfamNames[h], "_TEs_overlapping_", peaks, "_", region, "_peaks_ranLoc_smoothed_target_and_", flankName, "_flank_dataframe.txt"))
  outDFcolMeans <- list(paste0(matDir, libName,
                               "_norm_cov_", RNAfamNames[h], "_TEs_overlapping_", peaks, "_", region, "_peaks_smoothed_target_and_", flankName, "_flank_dataframe_colMeans.txt"),
                        paste0(matDir, libName,
                               "_norm_cov_", RNAfamNames[h], "_TEs_overlapping_", peaks, "_", region, "_peaks_ranLoc_smoothed_target_and_", flankName, "_flank_dataframe_colMeans.txt"))
