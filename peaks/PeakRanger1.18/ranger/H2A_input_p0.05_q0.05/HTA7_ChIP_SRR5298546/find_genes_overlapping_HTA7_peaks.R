...
# Separately for arms and pericentromeres, find genes that overlap
# HTA7 peaks overlapping or not overlapping HTA6 peaks or H3K9me2 peaks
# and report gene IDs for analysis of GO term enrichment and
# meiocyte-specifically expressed gene enrichment

# Usage:
# ./find_genes_overlapping_HTA7_peaks.R arm
