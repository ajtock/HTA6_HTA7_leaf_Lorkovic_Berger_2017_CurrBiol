...
# csmit -m 100G -c 32 "/applications/R/R-4.0.0/bin/Rscript permTest_genomewide_HTA6_overlapping_HTA7_peaks_vs_TEfams.R 10000"

args <- commandArgs(trailingOnly = T)
perms <- as.numeric(args[1])

peakName1 <- "HTA6_overlapping_HTA7_genomewide_peaks"
...
HTA6_HTA7_overlaps <- findOverlaps(query = HTA7,
                                   ...
                                   ignore.strand = TRUE,
                                   select = "all")
peaksGR <- HTA6[unique(subjectHits(HTA6_HTA7_overlaps))]
