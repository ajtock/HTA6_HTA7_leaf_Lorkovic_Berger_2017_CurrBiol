...
# Usage:
# ./TE_families_wt_only_HTA6_overlapping_HTA7_genomewide_peaks.R "Genome-wide HTA6 peaks overlapping HTA7 peaks" "HTA6_HTA7" HTA6_overlapping_HTA7 HTA6_overlapping_HTA7 genomewide 10000

library(ggplot2)
library(ggthemes)

#plotTitle <- "Genome-wide HTA6 peaks overlapping HTA7 peaks"
#pt1Name <- "HTA6_HTA7"
#pt1LibName <- "HTA6_overlapping_HTA7" 
#ptOrderLibName <- "HTA6_overlapping_HTA7"
#region <- "genomewide" 
