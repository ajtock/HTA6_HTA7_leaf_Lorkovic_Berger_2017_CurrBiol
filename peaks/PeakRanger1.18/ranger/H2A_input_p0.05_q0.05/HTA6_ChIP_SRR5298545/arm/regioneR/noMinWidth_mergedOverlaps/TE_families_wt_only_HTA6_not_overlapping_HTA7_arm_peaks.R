...
# Usage:
# ./TE_families_wt_only_HTA6_not_overlapping_HTA7_arm_peaks.R "Arm HTA6 peaks not overlapping HTA7 peaks" "HTA6_not_HTA7" HTA6_not_overlapping_HTA7 HTA6_not_overlapping_HTA7 arm 10000

library(ggplot2)
library(ggthemes)

#plotTitle <- "Arm HTA6 peaks not overlapping HTA7 peaks"
