...
# Usage:
# ./TE_families_wt_only_HTA6_overlapping_HTA7_arm_peaks.R "Arm HTA6 peaks overlapping HTA7 peaks" "HTA6_HTA7" HTA6_overlapping_HTA7 HTA6_overlapping_HTA7 arm 10000

library(ggplot2)
library(ggthemes)

#plotTitle <- "Arm HTA6 peaks overlapping HTA7 peaks"
#pt1Name <- ""HTA6_HTA7""
