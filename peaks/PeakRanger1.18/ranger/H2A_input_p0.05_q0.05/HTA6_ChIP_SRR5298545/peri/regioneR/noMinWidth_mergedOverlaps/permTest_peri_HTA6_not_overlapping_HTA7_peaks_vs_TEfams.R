...
# csmit -m 100G -c 32 "/applications/R/R-3.3.2/bin/Rscript permTest_peri_HTA6_not_overlapping_HTA7_peaks_vs_TEfams.R 10000"

args <- commandArgs(trailingOnly = T)
perms <- as.numeric(args[1])

peakName1 <- "HTA6_not_overlapping_HTA7_peri_peaks"
