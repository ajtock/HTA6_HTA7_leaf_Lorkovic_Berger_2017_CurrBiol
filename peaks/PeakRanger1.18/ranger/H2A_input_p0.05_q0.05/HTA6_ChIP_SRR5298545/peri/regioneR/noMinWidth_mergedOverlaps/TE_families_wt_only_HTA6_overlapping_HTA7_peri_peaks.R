...
# Usage:
# ./TE_families_wt_only_HTA6_overlapping_HTA7_peri_peaks.R "Pericentromeric HTA6 peaks overlapping HTA7 peaks" "HTA6_HTA7" HTA6_overlapping_HTA7 HTA6_overlapping_HTA7 peri 10000

library(ggplot2)
library(ggthemes)

#plotTitle <- "Pericentromeric HTA6 peaks overlapping HTA7 peaks"
#pt1Name <- ""HTA6_HTA7""
